taskName = "Problem 2. HTML binding";
function Main(bufferElement) {
    ...
    WriteLine('<div data-bind-content="name"></div>'.bind(attributes1));

    var attributes2 = {name: 'Elena', link: 'http://telerikacademy.com'};
    WriteLine('<a data-bind-content="name" data-bind-href="link" data-bind-class="name"></\a>'.bind(attributes2));
}